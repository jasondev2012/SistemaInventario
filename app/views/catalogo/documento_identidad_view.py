...
class DocumentoIdentidadView(ttk.Frame):
    ...
    def abrir_registro_documento_identidad(self, intDocumentoIdentidadID):
        ...
        self.dialog.title("Editar Rol" if intDocumentoIdentidadID > 0 else "Nuevo Rol")
        ...
        RolRegistroView(self.dialog, intDocumentoIdentidadID, self.on_register_success).pack(fill="both", expand=True)
